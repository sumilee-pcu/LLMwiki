...
3. [Perplexity 사업 아이디어 검증](wiki/pages/perplexity-business-idea-validation.md) — 구현 전 시장성·경쟁·지불 의사·MVP 가능성 점검
4. [바이브 코딩 활용 사례](wiki/pages/vibe-coding-use-cases.md) — 10가지 활용 사례 적합도 분류
...
| [Perplexity 사업 아이디어 검증](wiki/pages/perplexity-business-idea-validation.md) | Perplexity Deep Research로 사업 아이디어의 시장성, 경쟁, 지불 의사, 리스크, MVP 가능성을 빠르게 점검 |
...
| [Perplexity Deep Research 사업 아이디어 검증 메모 2026-05-28](wiki/sources/perplexity-business-validation-2026-05-28.md) | Perplexity 공식 Deep Research 문서와 사용자 제공 사업 검증 프롬프트 |
