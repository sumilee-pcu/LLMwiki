...
3. [유용한 GitHub 저장소](wiki/pages/useful-github-repositories.md) — 위키가 다루는 도구 카탈로그
...
2. [TradingAgents](wiki/pages/tradingagents.md) — 멀티에이전트 역할 분리 사례
3. [로컬 AI 작업실](wiki/pages/local-ai-workbench.md) — Ollama 로컬 모델과 위키 문맥 연결
